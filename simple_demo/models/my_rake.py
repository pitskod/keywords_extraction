...
class Rake(object):
    ...
    def get_phrases(self):
       return self._generate_phrases(sentences)
    ...
    def _generate_phrases(self, sentences): ## changed by darya
        ...
        for sentence in sentences:
            #word_list = [word.lower() for word in wordpunct_tokenize(sentence)]
             phrase_list.extend(self._get_phrase_list_from_words(sentence))
        return phrase_list
    ...
    def _get_phrase_list_from_words(self, word_list):
        ...
        for n in range(self.min_length, self.max_length + 1):
            phrases.extend(ngrams(word_list, n))
        return phrases
